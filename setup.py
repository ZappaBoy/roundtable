...
packages = \
    ['roundtable',
     'roundtable.models',
     'roundtable.models.settings',
     'roundtable.services',
     'roundtable.shared',
     'roundtable.shared.decorators',
     'roundtable.shared.exceptions',
     'roundtable.shared.utils']
